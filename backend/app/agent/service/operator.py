...
from backend.app.agent.service.agents.chat_agent import get_chat_agent
...
def get_agent(
    ...
    elif agent_id == AgentType.CHAT:
        return get_chat_agent(model_id=model_id, user_id=user_id, session_id=session_id, debug_mode=debug_mode)
    else:
