...
import CocktailRecommendation from "./pages/CocktailRecommendation";
				...
				<div className="container">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						...
						<div className="md:col-span-1">
							...
							<p className="text-sm text-gray-400 mb-4">找到适合您心情的鸡尾酒，让每一次品尝都成为难忘的体验。</p>
	...
	return (
		<Router>
			<Routes>
				...
				<Route path="/cocktail/recommendation" element={<CocktailRecommendation />} />
			</Routes>
		</Router>
	);
};
